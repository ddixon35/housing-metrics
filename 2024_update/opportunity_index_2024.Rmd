...
opportunity_acs_22$race_ethnicity <- factor(opportunity_acs_21$race_ethnicity,
                                            levels = c("AIAN",
                                                       "Asian",
...
opportunity_acs_22_new <- subset(opportunity_acs_21, select = c("geoid20", "census_tract", "geoid10", "race_ethnicity", "cnty", "county2", 
