...
subtitle: "Data sources: ACS, 5-year 2018-2022"
author: "David Dixon"
...
acs_race_totals <- opportunity_acs_22_new %>%
...
acs_race_opp <- opportunity_acs_22_new %>%
...
acs_comb_low_verylow <- acs_low_verylow %>%
  add_column(total_region_count_RE = rep(c(25452, 599211, 234085, 439037, 35345, 596400, 2525292), each = 2), 
             .after = 'count_moe')

# 3a. calculate share of low and very low for each race/ethniciy

acs_comb_low_verylow$share <- acs_comb_low_verylow$count/acs_comb_low_verylow$total_region_count_RE

# 3b. calculate share_moe
...
setwd("J:/Projects/V2050/Housing/Monitoring/2024Update/Data/metric06_access_to_opp_by_race")

write.csv(opportunity_acs_22_new, "r_output 2022 5YR_ACS_opportunity.csv", row.names=FALSE)
```
